...
export default function NewProductPage() {
    ...
    const [unit, setUnit] = useState("110g");
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        if (imageFile) {
            ...
            if (uploadedUrl) {
                ...
                alert("L'upload de l'image a échoué, le produit sera créé sans image.");
            }
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                <Link href="/produits" className="p-2 hover:bg-gray-100 rounded-full text-gray-500">
                    <ArrowLeft className="h-5 w-5" />
                </Link>
                <h1 className="text-2xl font-bold text-[var(--cookie-brown)]">Nouveau Produit</h1>
            </div>
                ...
                <form onSubmit={handleSave} className="space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Ex: Gaufres fines rhum"
                        />
                    </div>
                            ...
                            >
                                {previewUrl ? (
                                    ...
                                    <div className="text-center p-6">
                                        ...
                                        <p className="text-sm font-medium text-gray-700">Cliquez pour uploader une photo</p>
